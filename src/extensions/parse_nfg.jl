let BYTE_SPACE::UInt8     = UInt8(' '),
    BYTE_QUOTE::UInt8     = UInt8('"'),
    BYTE_LBRACE::UInt8    = UInt8('{'),
    BYTE_RBRACE::UInt8    = UInt8('}'),
    BYTE_BACKSLASH::UInt8 = UInt8('\\'),
    BYTE_LF::UInt8        = UInt8('\n')
    ...
    """
    Parse a Gambit floating-point payoff file.
    """
