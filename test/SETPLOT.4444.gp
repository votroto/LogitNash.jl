...
splot  '< LC_ALL=C; awk ''NF>2{printf "%.1f %.3f %s\n", ($1+$2*0.37+$3*0.61), $9, $0}'' /tmp/path.dat | sort -g -k1,1 -k2,2 | cut -d'' '' -f3-' u 1:2:(($9 >= 0) ? $3 : NaN):(log($9+1)) w p lc palette pt 7 ps 1 notitle, '' u 1:2:(($9 < 0) ? $3 : NaN) w p lc 'black' pt 7 ps 0.01 notitle